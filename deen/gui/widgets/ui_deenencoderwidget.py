...
class Ui_DeenEncoderWidget(object):
    def setupUi(self, DeenEncoderWidget):
        ...
        self.gridLayout.addWidget(self.side_menu, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.search_group, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.error_message_layout_widget, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.content_area_layout_widget, 1, 1, 5, 1)
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.plugin_tree_view)
        item_0 = QtWidgets.QTreeWidgetItem(self.plugin_tree_view)
        self.gridLayout.addWidget(self.plugin_tree_view, 1, 0, 1, 1)
        ...
        self.horizontalLayout_2.addWidget(self.toggle_text_view)
        ...
        self.horizontalLayout_2.addWidget(self.toggle_hex_view)
        ...
        self.horizontalLayout_2.addWidget(self.toggle_formatted_view)
    ...
    def retranslateUi(self, DeenEncoderWidget):
        ...
        self.toggle_text_view.setToolTip(_translate("DeenEncoderWidget", "Text View"))
        self.toggle_text_view.setText(_translate("DeenEncoderWidget", "TV"))
        self.toggle_hex_view.setToolTip(_translate("DeenEncoderWidget", "Hex View"))
        self.toggle_hex_view.setText(_translate("DeenEncoderWidget", "HV"))
        self.toggle_formatted_view.setToolTip(_translate("DeenEncoderWidget", "Formatted View"))
        self.toggle_formatted_view.setText(_translate("DeenEncoderWidget", "FV"))
